...
if (feedbackBtn && feedbackModal && closeBtn && feedbackForm && feedbackMessage) {
  ...
  feedbackForm.addEventListener('submit', (event) => {
    ...
    if (message) {
      alert('Votre feedback a été envoyé : ' + message);
      feedbackMessage.value = ''; // Réinitialiser le champ
      feedbackModal.style.display = 'none'; // Fermer la modale
    } else {
