...
require_once $_SERVER['DOCUMENT_ROOT'] . '/espace_comm/espace communotaire/vendor/autoload.php';
                    ...
                    if ($existingUser) {
                        ...
                        try {
                            ...
                            if (isset($_FILES['photo_profil']) && $_FILES['photo_profil']['error'] === UPLOAD_ERR_OK) {
                                $uploadDir = $_SERVER['DOCUMENT_ROOT'] . '/espace_comm/espace communotaire/uploads/';
                                ...
                                if (!in_array($fileType, $allowedTypes) || $fileSize > $maxFileSize || !is_dir($uploadDir) || !is_writable($uploadDir)) {
                                    ...
                                    if (move_uploaded_file($fileTmpName, $uploadPath)) {
                                        ...
                                        $python_script = '\espace_comm\espace communotaire\scripts\generate_encoding.py';
...
<head>
    ...
    <link href="/espace_comm/espace communotaire/assets2/css/nucleo-icons.css" rel="stylesheet" />
    <link href="/espace_comm/espace communotaire/assets2/css/nucleo-svg.css" rel="stylesheet" />
    <link href="/espace_comm/espace communotaire/assets2/css/bootstrap.min.css" rel="stylesheet" />
    <link id="pagestyle" href="/espace_comm/espace communotaire/assets2/argon-dashboard.css?v=2.1.0" rel="stylesheet" />
    <link href="/espace_comm/espace communotaire/styles.css" rel="stylesheet">
...
<body class="bg-gray-100">
    ...
    <header>
        <div class="logo">
            <img src="/espace_comm/espace communotaire/innoconnect.jpeg" alt="InnoConnect Logo">
        </div>
        <nav>
            <ul>
