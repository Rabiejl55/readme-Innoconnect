...
<head>
    ...
    <style>
        ...
        .toggle-form-btn:hover .tooltip-text {
            visibility: visible;
            opacity: 1;
        }
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-end mb-3">
                <button class="toggle-form-btn" onclick="toggleForm()">
                    ...
                    <span class="tooltip-text">Create a new discussion</span>
                </button>
            </div>
                    ...
                    <?php foreach ($forums as $forum): ?>
                        <div class="forum-card">
                            ...
                            <div class="actions">
                                ...
                                <!-- Option 1: alert() (default) -->
                                <a href="?delete=<?php echo $forum['id']; ?>" class="btn btn-danger btn-sm" onclick="alert('Are you sure you want to delete this discussion?'); return true;">
                                    <i class="bi bi-trash"></i> Delete
                                </a>
                                <!-- Option 2: Custom Bootstrap modal (commented out, uncomment to use) -->
                                <!--
                                <button class="btn btn-danger btn-sm" onclick="showDeleteModal(<?php echo $forum['id']; ?>)">
                                    <i class="bi bi-trash"></i> Delete
                                </button>
                                -->
                            </div>
            ...
            <!-- Custom Delete Confirmation Modal (Option 2, commented out) -->
            <!--
    ...
    <script>
        ...
        function toggleForm() {
            ...
            if (formContainer.style.display === 'none' || formContainer.style.display === '') {
                ...
                toggleBtn.querySelector('.tooltip-text').textContent = 'Close the form';
                // Scroll to form
                ...
                toggleBtn.querySelector('.tooltip-text').textContent = 'Create a new discussion';
                // Reset form
        ...
        // Custom delete modal function (Option 2, commented out)
        /*
        function showDeleteModal(forumId) {
            const modal = new bootstrap.Modal(document.getElementById('deleteConfirmModal'));
            const deleteLink = document.getElementById('confirmDeleteLink');
            deleteLink.href = `?delete=${forumId}`;
            modal.show();
        }
        */
    </script>
