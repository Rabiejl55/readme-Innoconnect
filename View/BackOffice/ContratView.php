              ...
              <div class="card-header pb-0">
                <div class="left-buttons">
                  <div class="btn-group-contracts">
                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#innovatorModal">
                      <i class="fas fa-user-tie me-1"></i> Contrat Innovateur
                    </button>
                    <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#investorModal">
