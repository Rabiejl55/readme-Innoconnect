...
<body class="g-sidenav-show bg-gray-100">
              ...
              <div class="card-header pb-0">
                <div class="left-buttons">
                  <div class="btn-group-contracts">
                    ...
                    <div class="btn-group">
                      <a href="?sort=date_asc" class="btn btn-primary btn-sm">
                        <i class="fas fa-sort-amount-down-alt me-1"></i> Date ↑
                      </a>
                      <a href="?sort=date_desc" class="btn btn-primary btn-sm">
                    ...
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                        <?php if ($current_page > 1): ?>
                          <li class="page-item">
                            <a class="page-link" href="?page=<?php echo $current_page - 1; ?><?php echo isset($_GET['sort']) ? '&sort=' . htmlspecialchars($_GET['sort']) : ''; ?>" aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                          <li class="page-item <?php echo $i === $current_page ? 'active' : ''; ?>">
                            <a class="page-link" href="?page=<?php echo $i; ?><?php echo isset($_GET['sort']) ? '&sort=' . htmlspecialchars($_GET['sort']) : ''; ?>">
                              <?php echo $i; ?>
                            </a>
                          </li>
                        <?php endfor; ?>
                        ...
                        <?php if ($current_page < $total_pages): ?>
                          <li class="page-item">
                            <a class="page-link" href="?page=<?php echo $current_page + 1; ?><?php echo isset($_GET['sort']) ? '&sort=' . htmlspecialchars($_GET['sort']) : ''; ?>" aria-label="Next">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (sortParam) {
            const activeButton = document.querySelector(`a[href="?sort=${sortParam}"]`);
            if (activeButton) {
